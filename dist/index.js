...
function createAuthModule(_ref) {
  ...
  var parseHash = _rxjs.Observable.create(function (obs) {
    return auth0.parseHash(function (err, payload) {
      ...
      errCheck.swap((0, _ramda.always)(payloadCheck), _helpers.Failures.Callback).map(_helpers.calcExipryTime).either((0, _helpers.callError)(obs), (0, _helpers.callNextComplete)(obs));
    });
  });
  ...
  var checkSession = function checkSession() {
    ...
    return _rxjs.Observable.create(function (obs) {
      return auth0.checkSession(options, function (err, result) {
        return (0, _helpers.fromNullable)(err).swap((0, _ramda.always)(result), (0, _ramda.always)(_helpers.Failures.SSO)).map(_helpers.calcExipryTime).either((0, _helpers.callError)(obs), (0, _helpers.callNextComplete)(obs));
      });
    });
  };
