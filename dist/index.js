...
function CreateAuthModule(options, auth = Auth0Idp(options)) {
    ...
    const userInfo = (authResult) => {
        return pipeable_1.pipe(auth.userInfo(authResult.accessToken || ""), TE.mapLeft(exports.Failures.UserInfo));
    };
...
function OidcIdp(settings) {
    const oidc = new oidc_client_1.UserManager(Object.assign(Object.assign({}, settings), { automaticSilentRenew: true, includeIdTokenInSilentRenew: false }));
    ...
    return {
        ...
        userInfo: () => TE.tryCatch(() => oidc.getUser().then((x) => x === null || x === void 0 ? void 0 : x.profile), () => ({ error: "Failed userinfo" })),
